// src/components/shared/BidHistoryTable.jsx
import BidStatusBadge from '@/components/shared/BidStatusBadge'; // Updated import
        ...
        <tbody>
          {bids.map((bid) => (
            <tr key={bid.id} className="border-b">
              <td className="p-2">
                {format(new Date(bid.postedDate), 'MMM dd, yyyy')}
              </td>
